...
async def home(request: Request):
    ...
    if coach:
        ...
        <body class="bg-gray-900 text-white min-h-screen flex flex-col items-center justify-center">
            ...
            <div class="space-x-4">
                <a href="/riders" class="bg-blue-600 px-8 py-4 rounded-xl font-bold hover:bg-blue-500">Browse & Draft</a>
...
async def riders_page(request: Request):
    ...
    <body class="bg-gray-900 text-white p-10"><h1 class="text-2xl mb-4">Draft Riders</h1>
    <table class="w-full text-left">{rows}</table><a href="/" class="text-gray-400 mt-4 block">← Back</a></body>"""
...
async def my_team(request: Request):
    ...
    <body class="bg-gray-900 text-white p-10">
        ...
        <form action="/clear-team" method="post" class="mt-4">
            <button type="submit" class="text-red-500 hover:text-red-300 font-bold">Clear My Roster</button>
        </form>
